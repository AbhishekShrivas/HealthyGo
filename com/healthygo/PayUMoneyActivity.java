...
public class PayUMoneyActivity extends AppCompatActivity {
    ...
    */
    ...
    // Final Variables
    private String mMerchantKey = "vFvvisRq";
    private String mSalt = "XQXioIYqZq";
    ...
    private String mSuccessUrl = "http://www.healthygo.in";
    private String mFailedUrl = "http://www.healthygo.in";
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         * Creating WebView
         */
        webView = (WebView) findViewById(R.id.webViewPay);
...
//        ab.setTitle(getString(R.string.aboutus));
        ...
        Bundle bundle = getIntent().getExtras();
           if (bundle != null) {
            ...
            mFirstName = bundle.getString("finaln");
            mEmailId = bundle.getString("finale");
            mAmount = bundle.getDouble("finalam");
            mPhone = bundle.getString("finalp");
            mId = 5; //bundle.getInt("id");
            isFromOrder = true;
            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public void onPageFinished(WebView view, String url) {
                    ...
                    if (url.equals(mSuccessUrl)) {
                        ...
                        intent.putExtra("email_pay",mEmailId);
...
//        }
    ...
    private void onPressingBack() {
        ...
        if(isFromOrder)
            intent = new Intent(PayUMoneyActivity.this, LoginActivity.class);
        else
